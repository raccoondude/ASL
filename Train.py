...
#Add input Dense layer as a 32 x 32 x 3 (3072) shape 1024 nodes | input_image -> resize -> flatten -> fed into model | input layer, 1024
model.add(tensorflow.keras.layers.Dense(1024, input_shape=(3072,), activation="sigmoid"))
#Add another Dense layer with 512 nodes, activation: sigmoid | input layer (1024), 750, 512
model.add(tensorflow.keras.layers.Dense(512, activation="relu"))
#Add another Dense layer with 300 nodes
